...
<div id="kate">
  <ul>
     <li><a href="#" style="background-color:#000; color:#FFF;">Kategoriler</a></li>
            ...
            <li><a href="nike.php" style="background-color:#f49140;
	color:white;">Nike</a></li>
...
$listele=@mysql_query("select * from urunler where kategori_id=9",$baglan);
