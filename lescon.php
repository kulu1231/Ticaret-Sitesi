...
<title>Lescon Ayakkabılar</title>
<style type="text/css">
*
{
	margin:0px;
...
<div id="kate">
  <ul>
     <li><a href="#" style="background-color:#000; color:#FFF;">Kategoriler</a></li>
            ...
            <li><a href="lescon.php" style="background-color:#f49140;
	color:white;">Lescon</a></li>
...
$listele=@mysql_query("select * from urunler where kategori_id=8",$baglan);
