...
<div id="menu">
  <ul>
    ...
    <li><a href="spor.php"style="background-color:#f49140;
	color:white;">Spor</a></li>
    <li><a href="hak.php">Hakkımızda</a></li>
  
  </ul>
</div>

<div id="giris"><a href="giris.php" style="color:#f49140;">Giriş Yap veya Kaydol</a></div>
<div id="ara">
...
<div id="kate">
  <ul>
     <li><a href="#" style="background-color:#000; color:#FFF;">Kategoriler</a></li>
            ...
            <li><a href="spor.php" style="background-color:#f49140;
	color:white;">Spor Ayakkabı</a></li>
...
$listele=@mysql_query("select * from urunler where kategori_id=13",$baglan);
...
echo "<div class=resim>"."<img src=images/$resim width=201 height=214 />"."</div>";
echo "<div class=marka>"."$urunadi"."</div>";
echo "<div class=fiyat>"."<font color=green><b>$fiyat</b></font>"."</div>";
echo "<div class=satinal>".'<a href="ayrinti.php?Kimlik='.$goster['Kimlik'].'">'."<img src='images/satinal.PNG' width='101' height='36' /></a>."."</div>";
echo "</div>";
}
