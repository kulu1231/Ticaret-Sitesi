...
<title>Çocuk Ayakkabıları</title>
<style type="text/css">
*
{
	margin:0px;
...
<div id="menu">
  <ul>
    ...
    <li><a href="cocuk.php" style="background-color:#f49140;
	color:white;">Çocuk</a></li>
...
$listele=@mysql_query("select * from urunler where kategori_id=1",$baglan);
