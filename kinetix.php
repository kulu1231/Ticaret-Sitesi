...
<title>Kinetix Ayakkabılar</title>
<style type="text/css">
*
{
	margin:0px;
...
<div id="kate">
  <ul>
     <li><a href="#" style="background-color:#000; color:#FFF;">Kategoriler</a></li>
            ...
            <li><a href="kinetix.php" style="background-color:#f49140;
	color:white;">Kinetix</a></li>
  </ul>
</div>
<div id="rek">
   <?php
...
$listele=@mysql_query("select * from urunler where kategori_id=7",$baglan);
