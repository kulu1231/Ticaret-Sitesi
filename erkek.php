...
<title>Erkek Ayakkabıları</title>
<style type="text/css">
*
{
	margin:0px;
...
<div id="menu">
  <ul>
    ...
    <li><a href="erkek.php" style="background-color:#f49140;
	color:white;">Erkek</a></li>
...
$listele=@mysql_query("select * from urunler where kategori_id=5",$baglan);
