...
<title>Reebook Ayakkabılar</title>
<style type="text/css">
*
{
	margin:0px;
...
<div id="kate">
  <ul>
     <li><a href="#" style="background-color:#000; color:#FFF;">Kategoriler</a></li>
            ...
            <li><a href="reebook.php" style="background-color:#f49140;
	color:white;">Reebook</a></li>
...
$listele=@mysql_query("select * from urunler where kategori_id=11",$baglan);
