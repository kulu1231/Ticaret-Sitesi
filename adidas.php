...
<title>Adidas Ayakkabılar</title>
<style type="text/css">
*
{
	margin:0px;
...
<div id="kate">
  <ul>
     <li><a href="#" style="background-color:#000; color:#FFF;">Kategoriler</a></li>
            ...
            <li><a href="adidas.php" style="background-color:#f49140;
	color:white;">Adidas</a></li>
...
$listele=@mysql_query("select * from urunler where kategori_id=2",$baglan);
