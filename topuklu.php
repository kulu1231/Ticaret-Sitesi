...
<div id="kate">
  <ul>
     <li><a href="#" style="background-color:#000; color:#FFF;">Kategoriler</a></li>
            <li><a href="topuklu.php" style="background-color:#f49140;
	color:white;">Topuklu Ayakkabı</a></li>
...
$listele=@mysql_query("select * from urunler where kategori_id=14",$baglan);
